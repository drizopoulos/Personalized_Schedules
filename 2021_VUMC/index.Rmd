...
date: "Statistics Seminar, VUMC and AMC<br/>November 30, 2021"
output:
...
$$\begin{eqnarray}
p(y_{i1}, y_{i2}, T_i^L, T_i^R \mid {\color{red} b_i}) & = & p(y_{i1} \mid {\color{red} b_{i1}}) \; p(y_{i2} \mid {\color{red} b_{i2}}) \times \\
&& \quad \quad  
\left\{S(T_i^L \mid {\color{red} b_i}) - S(T_i^R \mid {\color{red} b_i})\right\} p({\color{red} b_i})\\
\end{eqnarray}$$
<br/>
...
- In general, we consider decisions at a fixed schedule
$$\begin{array}{l}
s_1, \ldots, s_N\\
s_1 = v\\
s_N = h
